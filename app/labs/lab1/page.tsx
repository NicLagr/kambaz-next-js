    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          ...
          <li>Add diced tomatoes and cook for 5 minutes</li>
          <li>Stir in pasta and season with salt and pepper</li>
      ...
      <Link href="https://github.com/NicLagr/kambaz-next-js/tree/a4" id="wd-github">GitHub Repository</Link>
    </div>
  );
}
