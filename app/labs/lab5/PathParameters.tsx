...
export default function PathParameters() {
  ...
  return (
    <div id="wd-path-parameters">
      ...
      <a id="wd-path-parameter-add" className="btn btn-primary me-2"
        href={`${HTTP_SERVER}/lab5/add/${a}/${b}`}>
        Add {a} + {b}
      </a>
      <a id="wd-path-parameter-subtract" className="btn btn-danger me-2"
        href={`${HTTP_SERVER}/lab5/subtract/${a}/${b}`}>
        Subtract {a} - {b}
      </a>
      <a id="wd-path-parameter-multiply" className="btn btn-success me-2"
        href={`${HTTP_SERVER}/lab5/multiply/${a}/${b}`}>
        Multiply {a} * {b}
      </a>
      <a id="wd-path-parameter-divide" className="btn btn-warning me-2"
